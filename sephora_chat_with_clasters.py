...
# -------------------------
# 3. Initialize clients (singleton to speed up reload)
# -------------------------
...
# -------------------------
# 4. Load cluster metadata (cached)
# -------------------------
@st.experimental_singleton
...
if submitted and query:
    with st.spinner('Searching reviews and clusters...'):
        ...
        # Retrieve nearest reviews from Pinecone
        matches = index.query(
        ...
        # Collect review texts and count clusters
        review_texts   = []
        cluster_counts = {}
